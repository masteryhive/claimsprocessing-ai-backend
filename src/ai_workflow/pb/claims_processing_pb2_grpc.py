...
import pb.claims_processing_pb2 as claims__processing__pb2
...
class ClaimsProcessingStub(object):
...
class ClaimsProcessingServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ClaimsProcessingServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'claims_processing.ClaimsProcessing', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('claims_processing.ClaimsProcessing', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class ClaimsProcessing(object):
    """Missing associated documentation comment in .proto file."""
