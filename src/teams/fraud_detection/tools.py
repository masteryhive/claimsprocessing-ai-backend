...
# ############## vehicle fraud ##################
# @tool
# async def validate_if_this_is_a_real_vehicle(
...
#         raise e
#     print(registrationNumber.strip().lower())
...
#     #     )
#     # print(niid_data["check_NIID_database_result"])
